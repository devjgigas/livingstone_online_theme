 ...
 */
?>
<?php print render($search['search_type']); ?>
<input placeholder=" Search the entire site" title="Search the entire site" type="text" id="edit-search-block-form--2" name="search_block_form"  size="15" maxlength="128" class="rounded search" >
